...
export const POST_DELIVERY_INPUTS_DATA = [
  {
    name: 'city',
    error: 'Будь ласка, введіть назву міста доставки (від 2 до 50 символів)',
    label: 'Місто',
    placeholder: 'Введіть місто доставки...'
  },
  {
    name: 'postOffice',
    error: 'Будь ласка, введіть номер відділення або адрессу доставки',
    label: 'Номер відділення / адресса',
    placeholder: 'Введіть номер відділення або адрессу..'
  }
];
...
export const DELIVERY_OPTIONS = [
  ...
  { key: 3, text: 'Укр.Пошта', value: 3 },
  { key: 4, text: 'Justin', value: 4 }
];

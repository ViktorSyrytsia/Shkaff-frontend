...
export const POST_DELIVERY_INPUTS_DATA = [
  ...
  {
    name: 'postOffice',
    error: 'Будь ласка, введіть номер відділення або індекс(для Укрпошти) (від 1 до 5 цифр)',
    label: 'Номер відділення (індекс якшо Укрпошта)',
...
export const DELIVERY_OPTIONS = [
  ...
  { key: 3, text: 'на відділення Justin', value: 4 },
  { key: 3, text: 'на відділення Укрпошти', value: 5 }
];
